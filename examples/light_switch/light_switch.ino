...
State state_light_on("light on", on_light_on_enter, NULL, &on_light_on_exit);
State state_light_off("light off", on_light_off_enter, NULL, &on_light_off_exit);
